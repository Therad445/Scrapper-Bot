...
class BotControllerTest {
    ...
    void testSendNotificationValidLinkUpdate() throws Exception {
        ...
        mockMvc.perform(post("/updates")
                ...
                .content("{ \"id\": 1, \"url\": \"http://example.com\", \"description\": \"Test description\", \"tgChatIds\": [123] }"))
    ...
    void testSendNotificationInvalidLinkUpdate() throws Exception {
        ...
        mockMvc.perform(post("/updates")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{ \"id\": null, \"url\": \"http://example.com\", \"description\": \"Test description\", \"tgChatIds\": [123] }"))
    ...
    void testSendNotificationInvalidUrl() throws Exception {
        ...
        mockMvc.perform(post("/updates")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{ \"id\": 1, \"url\": \"invalid-url\", \"description\": \"Test description\", \"tgChatIds\": [123] }"))
            .andExpect(status().isBadRequest());
        verify(telegramBotService, never()).sendMessage(any(), any());
    }
    ...
    void testSendNotificationInvalidJson() throws Exception {
        ...
        mockMvc.perform(post("/updates")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{ \"id\": 1, \"url\": \"http://example.com\", \"description\": \"Test description\" }"))
            .andExpect(status().isBadRequest());
